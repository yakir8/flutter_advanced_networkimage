...
class ZoomableWidget extends StatefulWidget {
  ...
  /// When the Offset value changed, the callback will be invoked.
          ...
          child: _ZoomableChild(
            ...
            child: LayoutBuilder(
              builder: (BuildContext context, BoxConstraints constraints) {
                _containerSize =
                    Size(constraints.maxWidth * ( 1 - _zoom / 10),
                        constraints.maxHeight * (0.85 - _zoom / 10));
                return Center(
...
class _ZoomableChildState extends AnimatedWidgetBaseState<_ZoomableChild> {
  ...
  Widget build(BuildContext context) {
    return Transform(
      ...
      origin: Offset(-_panOffset
          .evaluate(animation)
          .dx, -_panOffset
          .evaluate(animation)
          .dy),
      transform: Matrix4.identity()
        ..translate(_panOffset
            .
        evaluate(animation)
            .dx, _panOffset
            .evaluate(animation)
            .dy)
        ..scale(_zoom.evaluate(animation),
